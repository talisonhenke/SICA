            ...
            @foreach ($products as $product)
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="product-card">
                        ...
                        @if (Auth::check() && Auth::user()->user_lvl === 'admin')
                            <div class="status-switch {{ $product->status ? 'active' : '' }}"
                                onclick="toggleStatus({{ $product->id }})"></div>
                        ...
                        <div class="product-body">
                            ...
                            <div class="product-main-actions">
                                <a href="{{ route('products.show', $product->id) }}" class="btn btn-sm btn-primary">Ver
                                    Produto</a>
                                @if (Auth::check())
                                    {{-- Usuário logado: mantém botão normal --}}
