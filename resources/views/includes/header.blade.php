    ...
    <nav class="navbar navbar-expand-lg px-3">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
            <ul class="navbar-nav mb-2 mb-lg-0 align-items-center">
                ...
                {{-- ========================= --}}
                {{-- USUÁRIO LOGADO (NÃO ADMIN, VERIFICADO) --}}
                {{-- ========================= --}}
                @if (Auth::check() && Auth::user()->hasVerifiedEmail() && Auth::user()->user_lvl !== 'admin')
                    <li class="nav-item">
                ...
                @else
                    {{-- Visitante OU usuário não verificado --}}
                    <li class="nav-item ms-lg-3">
                        <a class="btn btn-outline-light px-3 py-1 rounded-pill"
                            href="{{ Auth::check() ? route('verification.notice') : route('login') }}">
                            Entrar
                        </a>
                    </li>
                @endif
