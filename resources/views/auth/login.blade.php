                    ...
                    <div class="card login-card">
                        <div class="row g-0">
                            ...
                            <div class="col-lg-6 left-panel">
                                ...
                                <form method="POST" action="{{ route('login.post') }}">
                                    ...
                                    <div class="form-group mb-3">
                                        <input type="email" name="email"
                                            ...
                                            placeholder="Seu email" value="{{ old('email') }}" required>
                                ...
                                @if ($errors->any() || session('status'))
                                    <div class="toast-container position-fixed bottom-0 end-0 p-3" style="z-index: 1100">
                                        <div id="loginToast" class="toast align-items-center text-bg-danger border-0 show"
                            ...
                            <div class="col-lg-6 right-panel">
                                ...
                                <p class="small">
                                    Consulte plantas medicinais, usos, contraindicações e mantenha sua pesquisa sempre
                                    organizada.
                                </p>
                            </div>
